...
![Version: 0.1.0-Beta.0](https://img.shields.io/badge/Version-0.1.0--Beta.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)

## Installing the Chart

Install via OCI Registry:
```bash
helm install cryptpad oci://ghcr.io/cryptpad/helm/cryptpad --version 0.1.0-Beta.0
```
...
helm install cryptpad cryptpad-github/cryptpad --version 0.1.0-Beta.0
```
cd
## Signing
...
```bash
  ...
  helm fetch --verify cryptpad-github/cryptpad --version 0.1.0-Beta.0 --keyring helm-charts.gpg
```
