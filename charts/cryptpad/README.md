...
```bash
helm install cryptpad oci://ghcr.io/cryptpad/helm/cryptpad --version 0.1.0
```
...
helm install cryptpad cryptpad-github/cryptpad --version 0.1.0
```
cd
## Signing
...
```bash
  ...
  helm fetch --verify cryptpad-github/cryptpad --version 0.1.0 --keyring helm-charts.gpg
```
