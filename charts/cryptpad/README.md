...
```bash
helm install cryptpad oci://ghcr.io/cryptpad/helm/cryptpad --version 0.0.18
```
...
helm install cryptpad cryptpad-github/cryptpad --version 0.0.18
```
cd
## Signing
...
```bash
  ...
  helm fetch --verify cryptpad-github/cryptpad --version 0.0.18 --keyring helm-charts.gpg
```
...
| image.tag | string | `"version-5.5.0"` |  |
